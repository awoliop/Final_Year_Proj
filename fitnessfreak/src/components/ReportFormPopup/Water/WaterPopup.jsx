...
const WaterPopup = ({ setShowWaterPopup }) => {
  ...
  const [water, setWater] = useState({ date: "", amountInMilliliters: "" });
  ...
  const getWater = async () => {
    ...
    try {
      ...
      if (data.ok) {
        ...
        toast.error("Error in getting the water intake data");
      }
    } catch (error) {
      toast.error("Error in getting the water intake data");
      console.log(error);
      ...
      fetch(process.env.NEXT_PUBLIC_BACKEND_API + "/watertrack/deletewaterentry", {
        ...
        .then((data) => {
          if (data.ok) {
            ...
            toast.error("Error  in deleting the water intake item");
          }
        });
    } catch (error) {
      toast.error("Error in deleting water intake item");
      console.error(error);
    }
  };
  ...
  return (
    <div className="popupout">
      ...
      <div className="popupbox">
        ...
        <Button variant="contained" color="warning" onClick={saveWater}>
          save
        </Button>
